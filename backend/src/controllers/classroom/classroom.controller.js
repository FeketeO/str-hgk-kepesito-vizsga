 ...
 */
 ...
 exports.create = (req, res, next) => {
     ...
     return service.create(req.body)
         ...
         .catch(err => {
             console.log(err);
             return new createError.InternalServerError('Clasroom could not save');
         });
 };
 ...
 exports.findOne = (req, res, next) => {
     return service.findOne(req.params.id)
         .then(entity => {
             if (!entity) {
                 return next(new createError.NotFound("Clasroom not found"));
             }
 ...
 exports.update = (req, res, next) => {
     ...
     return service.update(req.params.id, req.body)
         ...
         .catch(err => {
             console.error(err)
             return next(new createError.InternalServerError('Could not update clasroom'));
         });
 };
 ...
 exports.delete = (req, res, next) => {
     return service.delete(req.params.id)
         ...
         .catch(err => {
             console.error(err);
             return next(new createError.InternalServerError('Could not delete clasroom'));
         });
 };